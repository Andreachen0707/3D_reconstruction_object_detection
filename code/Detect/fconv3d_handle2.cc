//mex -largeArrayDims CFLAGS='-O3 -ffast-math -std=c++11' fconv3d_handle.cc
#include "mex.h"
#include <math.h>
#include <string.h>

// convolve A and B
void process(double* A, double* B, double* MA, bool* MB, bool* E, bool* DontCare, double* C, const mwSize* A_dims, const mwSize* B_dims, const mwSize* C_dims, double* Space, double* scalemissing,double* occCount) {
	double* dst = C;
	bool* isE = E;
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) { 
	...
	// do convolutions
	process(A, B, MA, MB, E, DontCare, C, A_dims, B_dims, C_dims,Space,scalemissing,occCount);
}
