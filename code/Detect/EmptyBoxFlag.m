...
y1 = 1:sizePtI(1)-sizeTemplate(1)+1;
y2 = sizeTemplate(1):sizePtI(1);
x1 = 1:sizePtI(2)-sizeTemplate(2)+1;
x2 = sizeTemplate(2):sizePtI(2);
z1 = 1:sizePtI(3)-sizeTemplate(3)+1;
z2 = sizeTemplate(3):sizePtI(3);
