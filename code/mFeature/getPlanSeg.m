function [imageSeg]= getPlanSeg(XYZworldframeTest,SpaceTest,imgSize,imageNum)
...
segpath = ['/n/fs/modelnet/post_segment/PlanesegImage'];
onPlaneThreshold =0.055;
sizethr =500;
normalAgreeThreshold =0.8;
try 
    %load(sprintf('%s/%04d.mat',segpath,imageNum))
%catch
